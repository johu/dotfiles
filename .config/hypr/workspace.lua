...
hl.workspace_rule { workspace = '1', monitor = main, default = true, on_created_empty = terminal .. ' -e tmux new-session -A -s arch' }
...
hl.workspace_rule { workspace = '6', monitor = main }
hl.workspace_rule { workspace = '7', monitor = main }
hl.workspace_rule { workspace = '8', monitor = main }
hl.workspace_rule { workspace = '9', monitor = main }
